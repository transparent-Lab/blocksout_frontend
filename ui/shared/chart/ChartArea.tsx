...
const ChartArea = ({ id, xScale, yScale, color, data, disableAnimation, ...props }: Props) => {
  ...
  const defaultGradient = {
    startColor: useToken('colors', useColorModeValue('bitsat.100', 'bitsat.400')),
    stopColor: useToken('colors', transparentize(useColorModeValue('bitsat.100', 'bitsat.400'), 0)(theme)),
  };
